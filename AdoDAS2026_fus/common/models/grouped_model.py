...
class GroupedModel(nn.Module):
    ...
    def forward(
        ...
        backbone_output = self.backbone(flat_batch)
        session_reprs = backbone_output["output"]  # Extract the actual output
        ...
        return {
            ...
            "audio_features": backbone_output.get("audio_features"),  # For consistency loss
            "video_features": backbone_output.get("video_features"),
            "audio_mask": backbone_output.get("audio_mask"),
            "video_mask": backbone_output.get("video_mask"),
        }
