...
class GroupedModel(nn.Module):
    ...
    def forward(
        ...
        # NOTE: under nn.DataParallel, non-Tensor args are broadcast instead of scattered.
        # Derive local batch size from tensor input to avoid global/local mismatch.
        B = int(session_valid.shape[0])
